# -*- coding: utf-8 -*-
"""
Created on Fri Sep 22 02:32:57 2017

@author: Abhijeet singh
"""

#This file contains the stemmer and its related functions

"""
NLP has been used along wtih understanding of the english language to come up with this stemmer.
This was the stemmer used for creating the BoW model for the Million songs database.
Only the stem function is called by other scripts in this project.
The stem function calls other related functions in this file.
"""
...
def stem(word):
    """
    Stems the given word according to the way used by the musixmatch dataset

    param word:word that needs to be stemmed
    type word: string without spaces
    returns: nothing
    """
